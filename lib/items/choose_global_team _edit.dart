...
class ChooseGlobalScreenItemEdit extends StatefulWidget {
  Data2 datateam;

  ChooseGlobalScreenItemEdit(
    this.datateam,
  );

  @override
  _ChooseGlobalScreenItemEditState createState() =>
      _ChooseGlobalScreenItemEditState();
}

class _ChooseGlobalScreenItemEditState
    extends State<ChooseGlobalScreenItemEdit> {
  @override
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        cubit.userGlobalTeamSelectEdit(
