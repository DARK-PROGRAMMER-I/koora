...
class ChooseNationalScreenItem extends StatefulWidget {
  Data2 datateam;

  ChooseNationalScreenItem(
    this.datateam,
  );

  @override
  _ChooseNationalScreenItemState createState() =>
      _ChooseNationalScreenItemState();
}

class _ChooseNationalScreenItemState extends State<ChooseNationalScreenItem> {
  @override
