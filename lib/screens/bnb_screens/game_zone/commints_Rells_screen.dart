...
class CommintRellsScreen extends StatefulWidget {
  int id;
  String type;
  String ImageSrc;

  CommintRellsScreen(this.id, this.type, this.ImageSrc);

  @override
  _CommintRellsScreenState createState() => _CommintRellsScreenState();
}

class _CommintRellsScreenState extends State<CommintRellsScreen> {
  ...
  RellsCubit comments = RellsCubit();
  fetchNews() {
    setState(() {
      ...
      comments.getCommentReels(number: widget.id, number2: currentPage);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => RellsCubit()
        ..getCommentReels(number: widget.id, number2: currentPage),
