...
import '../../../../items/choose_global_team _edit.dart';
import '../../../../items/choose_global_team.dart';
import '../../../choose_team_screens/almontakab.dart/almontakhab_screen.dart';
import '../../../choose_team_screens/globalTeam/cubit/cubit.dart';
import '../../../choose_team_screens/globalTeam/cubit/state.dart';

class GlobalClubsScreenEdit extends StatefulWidget {
  @override
  _GlobalClubsScreenEditState createState() => _GlobalClubsScreenEditState();
}

class _GlobalClubsScreenEditState extends State<GlobalClubsScreenEdit> {
      ...
      child: BlocConsumer<GlobalTeamCubit, GlobalTeamStates>(
          ...
          builder: (context, state) {
            ...
            Future<dynamic> uploadImage(File file) async {
              ...
              await GlobalTeamCubit.get(context)
                              ...
                              child: GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    if (index == newsApi.articles.length) {
                                      ...
                                      return ChooseGlobalScreenItemEdit(
