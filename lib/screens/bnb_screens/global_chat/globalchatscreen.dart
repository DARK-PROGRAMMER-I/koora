...
import 'package:koora_app/screens/bnb_screens/global_chat/cubit/cubit.dart';
...
import '../my_team_chat/cubit_global/state.dart';
...
class _GlobalChatScreenState extends State<GlobalChatScreen> {
  GlobalChatCubit localchat = GlobalChatCubit();
  ...
  fetchNews() {
    setState(() {
      ...
      localchat.getGlobalChat(number: currentPage);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => GlobalChatCubit()..getGlobalChat(),
      child: BlocConsumer<GlobalChatCubit, GlobalChatStates>(
        listener: (context, state) async {
          var cubit = GlobalChatCubit.get(context);
