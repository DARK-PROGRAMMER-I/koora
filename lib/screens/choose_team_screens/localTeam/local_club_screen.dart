...
import '../globalTeam/global_club_screen.dart';
...
class LocalClubScreen extends StatefulWidget {
  @override
  _LocalClubScreenState createState() => _LocalClubScreenState();
}

class _LocalClubScreenState extends State<LocalClubScreen> {
      ...
      child: BlocConsumer<LocalTeamCubit, LocalTeamStates>(
        ...
        builder: (context, state) {
          ...
          Future<dynamic> uploadImage(File file) async {
            ...
            await localteamsuggest.userSuggest(mydata: formData);
